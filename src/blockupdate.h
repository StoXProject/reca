 ...
 *
 * RCSId: $Id: blockupdate.h 1 2013-03-28 13:54:24Z hanne $
 *
 */
/*!
  \file blockupdate.h
...
typedef struct
{
    /*!
      ...
      If equal to #GMRFLib_MODEOPTION_MODE, the mode of the posterior distribution is located and
      the Taylor-expansion is done around the mode. If equal to #GMRFLib_MODEOPTION_CURRENT, the
      expansion is done around the current value of <em>\b x</em>. 
    */
    int modeoption;
    ...
    */
    ...
    /*!
      ...
      Step length in the computation of a Taylor expansion or second order approximation of the
      log-likelihood.
    */
    double step_len;
}
...
int GMRFLib_2order_approx(double *a, double *b, double *c, double d, double x0, int indx,
			  double *x_vec, GMRFLib_logl_tp* loglFunc, char *loglFunc_arg, double *step_len);
int GMRFLib_2order_taylor(double *a, double *b, double *c, double d, double x0, int indx,
			  double *x_vec, GMRFLib_logl_tp* loglFunc, char *loglFunc_arg,
			  double *step_len);
int GMRFLib_blockupdate(double *laccept, 
			...
			GMRFLib_logl_tp *loglFunc_new, char *loglFunc_arg_new,
			GMRFLib_logl_tp *loglFunc_old, char *loglFunc_arg_old,
			char *fixed_value, 
			GMRFLib_graph_tp *graph,
			GMRFLib_Qfunc_tp *Qfunc_new, char *Qfunc_arg_new,    
			GMRFLib_Qfunc_tp *Qfunc_old, char *Qfunc_arg_old,
			GMRFLib_Qfunc_tp *Qfunc_old2new, char *Qfunc_arg_old2new,
			GMRFLib_Qfunc_tp *Qfunc_new2old, char *Qfunc_arg_new2old,    
			GMRFLib_constr_tp *constr_new, GMRFLib_constr_tp *constr_old,
			GMRFLib_optimize_param_tp *optpar,
			GMRFLib_blockupdate_param_tp *blockupdate_par);
...
int GMRFLib_init_GMRF_approximation(GMRFLib_problem_tp **problem, double *x, double *b, double *c, double *mean, double *d, 
				    GMRFLib_logl_tp *loglFunc, char *loglFunc_arg,
				    char *fixed_value, GMRFLib_graph_tp *graph, GMRFLib_Qfunc_tp *Qfunc, char *Qfunc_arg,    
...
int GMRFLib_init_GMRF_approximation_store(GMRFLib_problem_tp **problem, double *x, double *b, double *c, double *mean, double *d,
					  GMRFLib_logl_tp *loglFunc, char *loglFunc_arg, char *fixed_value, GMRFLib_graph_tp *graph,
					  GMRFLib_Qfunc_tp *Qfunc, char *Qfunc_arg, GMRFLib_constr_tp *constr, GMRFLib_optimize_param_tp *optpar,
